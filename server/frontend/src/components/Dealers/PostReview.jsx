...
const PostReview = () => {
  ...
  const postreview = async ()=>{
    ...
    if(firstname && lastname && 
       !firstname.includes("null") && 
       !lastname.includes("null")) {
        name = firstname + " " + lastname;
    }

    // Validate fields
    if(!model || review === "" || date === "" || 
       year === "" || model === "") {
    ...
    try {
        ...
        if (json.status === 200) {
            ...
            alert("Error posting review: " + JSON.stringify(json));
        }
    } catch(error) {
        console.log("Error:", error);
        alert("Error posting review!");
    }
  } // ← postreview function ends here ✅
